...
public:
     ...
     */
    eProsima_user_DllExport const std::array<char, 1280*1024>& data() const;

    /*!
     * @brief This function returns a reference to member data
     * @return Reference to member data
     */
    eProsima_user_DllExport std::array<char, 1280*1024>& data();
    /*!
     * @brief This function sets a value in member publish_time
     * @param _publish_time New value for member publish_time
     */
    eProsima_user_DllExport void publish_time(
...
private:
    ...
    std::array<char, 1280*1024> m_data;
    int64_t m_publish_time;
};
