...
{
    // m_index com.eprosima.idl.parser.typecode.PrimitiveTypeCode@79be0360
    m_index = 0;
    // m_message com.eprosima.idl.parser.typecode.StringTypeCode@22a67b4
    m_message ="";
    // m_data com.eprosima.idl.parser.typecode.ArrayTypeCode@57855c9a
    memset(&m_data, 0, (1280*1024) * 1);
    // m_publish_time com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3b084709
    m_publish_time = 0;
        ...
        size_t current_alignment)
{
    ...
    current_alignment += ((1280*1024) * 1) + eprosima::fastcdr::Cdr::alignment(current_alignment, 1);
...
void HelloWorld::data(
        const std::array<char, 1280*1024>& _data)
{
    m_data = _data;
}
 ...
 */
void HelloWorld::data(
        std::array<char, 1280*1024>&& _data)
{
 ...
 */
const std::array<char, 1280*1024>& HelloWorld::data() const
{
    return m_data;
}
 ...
 */
std::array<char, 1280*1024>& HelloWorld::data()
{
    return m_data;
}
/*!
 ...
 */
int64_t HelloWorld::publish_time() const
{
 ...
 */
int64_t& HelloWorld::publish_time()
{
    return m_publish_time;
}
