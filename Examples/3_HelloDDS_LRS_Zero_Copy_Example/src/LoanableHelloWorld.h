...
public:
     ...
     */
    eProsima_user_DllExport const std::array<char, 1280*720*3>& data() const;

    /*!
     * @brief This function returns a reference to member data
     * @return Reference to member data
     */
    eProsima_user_DllExport std::array<char, 1280*720*3>& data();
    /*!
...
private:
    ...
    uint32_t m_index;
    std::array<char, 1280*720*3> m_data;
