...
{
    // m_index com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3a883ce7
    m_index = 0;
    // m_data com.eprosima.idl.parser.typecode.ArrayTypeCode@4973813a
    memset(&m_data, 0, (1280*1024) * 1);
    // m_publish_time com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6321e813
    m_publish_time = 0;
 ...
 */
const std::array<char, 1280*1024>& LoanableHelloWorld::data() const
{
    return m_data;
}
 ...
 */
std::array<char, 1280*1024>& LoanableHelloWorld::data()
{
    return m_data;
}
/*!
